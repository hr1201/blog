...
![](https://cdn.staticaly.com/gh/hr1201/img@main/imgs/202307241948199.png)
...
const rain = () => {
    ...
    Arr.forEach((item, index) => {
        ...
        ctx.fillText(str[Math.floor(Math.random() * str.length)], index * 100, item * 10);
...
![](https://cdn.staticaly.com/gh/hr1201/img@main/imgs/202307242055399.png)
